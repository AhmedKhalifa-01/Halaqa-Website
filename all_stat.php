		...
		<div class="content-panel">
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<table>
					<tr>
						<th>عدد الطلبة الكلي</th>
						<th>عدد الحلقات الكلي</th>
						<th>عدد المعلمين</th>
						<th>عدد الدورات</th>
					</tr>
					<tr>
						<?php
							$sql = "SELECT COUNT(std_id) as count FROM students";
							$sql2 = "SELECT COUNT(ring_id) as count FROM ring GROUP BY staff_id";
							$sql3 = "SELECT COUNT(staff_id) as count FROM staff";
							$sql4 = "SELECT COUNT(c_id) as count FROM course";
							...
							echo '<tr>
									<td>'.mysqli_fethc_assoc($r1)['count'].'</td>
									<td>'.mysqli_fethc_assoc($r2)['count'].'</td>
									<td>'.mysqli_fethc_assoc($r3)['count'].'</td>
									<td>'.mysqli_fethc_assoc($r4)['count'].'</td>
									<td>'.mysqli_fethc_assoc($r5)['count'].'</td>
								</tr>';
						?>
						<th>عدد الطلبة الكلي</th>
					</tr>
