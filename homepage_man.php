				...
				<div class="card-grid">
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3 id="test">إدارة الأخبار الرئيسية</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="main_news_man.php">عرض</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/post.png" /></span>
								<h3 id="test">تغيير ملف التجويد</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="tajweed_man.php">عرض</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/post.png" /></span>
								<h3 id="test">إدارة النبذة عن المجمع</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="about_man.php">عرض</a>
						</div>
					</article>
					<?php
					...
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/post.png" /></span>
								<h3 id="test">إدارة المجمعات</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="community_man.php">عرض</a>
						</div>
					</article>
					<?php
					    }
