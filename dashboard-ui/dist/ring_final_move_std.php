	...
	if(isset($_POST['move_std'])){
		...
		if (!empty($students)) {
			foreach ($students as $std_id) {
				mysqli_query($conn,"UPDATE students SET temp_ring_id = '".$ring."', ring_id = '".$ring."' WHERE std_id = '".$std_id."'");
				echo "<script>alert('تم نقل الطالب بنجاح');</script>";
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="ring_final_move_std.php" method="post">
								...
								<p>اختر الطلبة لنقلهم من الحلقة : </p>
								<ul>
									<?php
