	...
	if(isset($_POST['move_std'])){
		...
		if (!empty($students)) {
			foreach ($students as $std_id) {
				mysqli_query($conn,"UPDATE students SET temp_ring_id = NULL, ring_id = NULL WHERE std_id = '".$std_id."'");
				echo "<script>alert('تم حذف الطالب بنجاح');</script>";
...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>حذف الطلبة</title>
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="ring_del_std.php" method="post">
