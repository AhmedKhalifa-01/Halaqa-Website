	...
	<div class="responsive-wrapper">
		...
		<div class="content">
			...
			<div class="content-main">
				...
				<table>
					<tr>
						<th>اسم الدورة / المتون</th>
						<th>اسم الطالب</th>
						<th>التاريخ</th>
						<th>الحالة</th>
					</tr>
					<?php
						$sql = "SELECT course.c_name,students.std_name,course_attendance.date,course_attendance.state FROM `course_attendance` 
						INNER JOIN course ON course_attendance.course_id = course.c_id 
						INNER JOIN students ON course_attendance.std_id = students.std_id
						";
						...
						if(mysqli_num_rows($result) > 0){
							while($row = mysqli_fetch_assoc($result)){
								echo '
									<tr>
										<td style = "width:400px;">'.$row['c_name'].'</td>
										<td style = "width:600px;">'.$row['std_name'].'</td>
