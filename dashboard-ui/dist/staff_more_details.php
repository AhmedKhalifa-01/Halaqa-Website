...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>التفاصيل</title>
	...
	<div class="responsive-wrapper">
		...
		<div class="content">
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<?php
						$sql = "SELECT * FROM staff WHERE staff_id LIKE '".$_GET['id']."'";
						$result = mysqli_query($conn,$sql);
						$row = mysqli_fetch_assoc($result);
							echo '<article class="card">
									...
									<div class="card-body">
										...
										$sql = "SELECT * FROM ring WHERE ring_man = '".$_GET['id']."'";
										$ress = mysqli_query($conn,$sql);
										if(mysqli_num_rows($ress) > 0){
											echo 'الحلقات المشرف عليها : ';
											echo '<ul style="margin-right:80px;">';
											while($rrow = mysqli_fetch_assoc($ress)){
												echo '<li style="padding:5px;"><a style="text-decoration:none;"href="ring_man.php">'.$rrow['ring_name'].'</a></li>';
											}
										}
										echo '</ul>';
