			...
			<div class="content-panel">
				<div class="vertical-tabs">
					...
					<?php }else{?>
						<a href="p_msgs.php">عرض رسائلي</a>
					<?php } ?>
					<a href="p_std_exc.php" class="active">الاستئذان للابن</a><div style="margin-bottom: 400px;">
</div>
				</div>
			</div>
							...
							while($row = mysqli_fetch_assoc($result)){
								echo '<article class="card">
										...
										<div class="card-footer">
											<a href="p_std_exc.php?std_id='.$row['std_id'].'">الاستئذان للطالب</a>
										</div>
									</article>
								';
							}
...
<?php
	...
	if(isset($_GET['std_id'])){
		$sql = "INSERT INTO `std_exc`(`std_id`,`sender`, `date`,`state`) VALUES ('".$_GET['std_id']."','".$_SESSION['email']."','".date('Y-m-d')."','انتظار')";
