	...
	<div class="responsive-wrapper">
		...
		<a href="visitor_acc.php" class="active">عرض الإحصائيات</a>
			...
			<div class="content-main">
				<center style="margin-bottom:20px;"><a href="std_single_state.php?std_id=<?php echo $_GET['std_id']; ?>&ring_id=<?php echo $_GET['ring_id']; ?>" class="button" style="width:100px;height:50px;">
					<span>رجوع</span>
				</a></center>
				<div class="card-grid">
				<article class="card" style="width:300px;">
								...
								<div class="card-body">	
									<form class="login-form" action = <?php if($_GET['type'] == "1"){
										echo "std_chartr.php?std_id=".$_GET['std_id']."&ring_id=".$_GET['ring_id']."";
									}else if($_GET['type'] == "2"){
										echo "std_rev_rec_face.php?std_id=".$_GET['std_id']."&ring_id=".$_GET['ring_id']."";
									}else if($_GET['type'] == "3"){
										echo "std_ex_ab_stat.php?std_id=".$_GET['std_id']."&ring_id=".$_GET['ring_id']."";
									}else{
										echo "none.php";
									}?>
									method = "post">
