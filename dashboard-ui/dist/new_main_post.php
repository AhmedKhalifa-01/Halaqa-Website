...
/* adding new post */
	...
	if(isset($_POST['add_news'])){
		$title = $_POST['title'];
		$secondary_title = $_POST['secondary_title'];
        ...
        //else{
			...
			if ($didUpload) {
				...
				$sql = "INSERT INTO `main_posts`(`title`, `secondary_title`, `img`, `date`, `end_date`) VALUES ('".$title."','".$secondary_title."','".$img."','".date('Y-m-d')."','".$end_date."')";
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="new_main_post.php" method="post" enctype="multipart/form-data">
								<input type="text" placeholder="العنوان" name="title"/>
								<input type="text" placeholder="العنوان الفرعي" name="secondary_title"/>	
								<p>تاريخ انتهاء الخبر</p>
								<input type="date" placeholder="العنوان الفرعي" name="end_date"/>								
