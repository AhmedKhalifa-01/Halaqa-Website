...
<html lang="ar" >
	<head>
	<meta charset="UTF-8">
	<link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>حضور الحلقة</title>
...
<!-- partial:index.partial.html -->
		<center><h1>حضور الحلقة</h1></center>
			<table>
				<thead>
					<tr>
						<th>الاسم</th>
				...
				<tbody>
					<?php
						$sql = "SELECT *
								...
								LEFT JOIN std_att ON students.std_id = std_att.std_id 
