		...
		if(isset($_POST['teachers'])){
			...
			if (!empty($teachers)) {
				foreach ($teachers as $teacher_id) {
					$sql = "DELETE FROM teacher_ring WHERE teacher_id = '".$teacher_id."' AND ring_id = '".$_GET['ring_id']."'";
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="remove_teacher_existing_ring.php?ring_id=<?php echo $_GET['ring_id']; ?>" method="post">
