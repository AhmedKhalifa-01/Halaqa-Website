...
<main class="main">
	<div class="responsive-wrapper">
		...
		<div class="content">
			...
			<a href="ring_man.php" class="button" style="margin-left:10px;width:100px;height:50px;">
					<span>رجوع</span>
				</a></br></br>
				<?php if($_SESSION['staff_job'] == "JOB_03" or $_SESSION['staff_job'] == "JOB_01"){ ?>
								...
								while($row = mysqli_fetch_assoc($result)){
									echo '<tr>';
										...
										if($row['status'] != 'إجازة'){
											if($row['state'] == "متوقف"){
												...
												if($canDo){										
													switch ($amountRev) {
														case 0:
															echo '<td style= "background-color: #280950;color:#fff;white-space: normal;word-wrap: break-word;max-width: 150px;"><a href="ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'" style="color:#fff;text-decoration:none;">التسميع</a></td>';
															break;
													case 1:
														echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: #34758f;color:#fff;"><div onclick="location.href=\'ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'\'" style="cursor:pointer;"><p style="font-size:14px;">تم التسميع، </br> اضغط للتسميع للمرة الثانية</p></div></td>';
														break;
													case 2:
														echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: orange;color:#fff;"><div onclick="location.href=\'ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'\'" style="cursor:pointer;"><p style="font-size:14px;">تم التسميع، </br> اضغط للتسميع للمرة الثالثة</p></div></td>';
														break;
													case 3:
														echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: purple;color:#fff;"><div onclick="location.href=\'ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'\'" style="cursor:pointer;"><p style="font-size:14px;">تم التسميع، </br> اضغط للتسميع للمرة الرابعة</p></div></td>';
														break;
													case 4:
														echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: blue;color:#fff;"><div onclick="location.href=\'ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'\'" style="cursor:pointer;"><p style="font-size:14px;">تم التسميع، </br> اضغط للتسميع للمرة الخامسة</p></div></td>';
														break;
													case 5:
														echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: darkblue;color:#fff;"><div onclick="location.href=\'ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'\'" style="cursor:pointer;"><p style="font-size:14px;">تم التسميع، </br> اضغط للتسميع مرة أخيرة</p></div></td>';
														break;
													default:
										...
										echo '<td style="white-space: normal;word-wrap: break-word;max-width: 150px;background-color: #742942;color:#fff;">
												<div onclick="location.href=\'old_ring_details.php?std_id='.$row['std_id'].'&ring_id='.$_GET['ring_id'].'&days=7\'" style="cursor:pointer;">
										...
										echo '<td class="adjust">
												<ul>
													...
													<li>
														<button class="vmem_btn" style="padding:7px;font-weight:600;margin-bottom:10px;">تعديل</button>
													</li>
													<div id="change_vmem" style="display:none">
														<form action="ring_det.php?ring_id='.$_GET['ring_id'].'&std_id='.$row['std_id'].'" method="post" onsubmit="return validateForm(this)">
															<input type="text" placeholder="'.$row['std_v_mem'].'" name="vmem" style="width:50px;height:20px;"/>
															<input type="submit" value="تغيير" name="change_v_mem" style="width:50px;height:25px;"/>
														</form>
													</div>
												</ul>
											</td>';
											echo '<td  class="adjust">
												<ul>
													...
													<div id="change_vmem" style="display:none">
														<form action="ring_det.php?ring_id='.$_GET['ring_id'].'&std_id='.$row['std_id'].'" method="post" onsubmit="return validateForm(this)">
															<input type="text" placeholder="'.$row['std_tested'].'" name="tested" style="width:50px;height:20px;"/>
															<input type="submit" value="تغيير" name="change_tested" style="width:50px;height:25px;"/>
														</form>
													</div>
												</ul>
											</td>';
