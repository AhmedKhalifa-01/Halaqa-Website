...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>حذف درجة التسميع</title>
								...
								while($row = mysqli_fetch_assoc($result)){
									echo '<tr>';
										echo '<td id="name" style="">'.$row['std_name'].'</td>';
											echo '<td class="data" style="cursor:pointer;" onclick="handleClick(\''.$row['std_id'].'\',\''.$_GET['ring_id'].'\')">اضغط لحذف الدرجات</td>';
...
<script>
		...
		function handleClick(std_id,ring_id){
			const url = 'del_ring_results.php?std_id=' + std_id + '&ring_id=' + ring_id;
