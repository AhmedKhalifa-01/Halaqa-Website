					...
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3>نسب درجات الحفظ و المراجعة</h3>
							</div>
						</div>
						<div class="card-body">	
						</div>
						<div class="card-footer">
							<a href="std_stat_select_date.php?type=1">مزيد من التفاصيل</a>
						</div>	
					</article> 
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/analysis.png" /></span>
								<h3>عدد أوجه الحفظ والمراجعة</h3>
							</div>
						</div>
						<div class="card-body">	
						</div>
						<div class="card-footer">
							<a href="std_stat_select_date.php?type=2">مزيد من التفاصيل</a>
						</div>	
					</article> 
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/analysis.png" /></span>
								<h3>نسب الغياب و الاستئذان</h3>
							</div>
						</div>
						<div class="card-body">	
						</div>
						<div class="card-footer">
							<a href="std_stat_select_date.php?type=3">مزيد من التفاصيل</a>
						</div>	
					</article> 
