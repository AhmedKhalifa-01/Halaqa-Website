...
/* adding new ring */
	...
	if(isset($_POST['add_ring'])){
		if(isset($_POST['students'])){
			...
			if (!empty($students)) {
				// INSERT INTO tasheeh_std
				foreach ($students as $std) {
					$sql = "INSERT INTO tasheeh_std (tasheeh_id, std_id) VALUES ('".$_GET['t_id']."','".$std."')";
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="add_to_existing_tasheeh.php?t_id=<?php echo $_GET['t_id']; ?>" method="post">
								<p>الحلقة</p>
								...
								<ul>
									...
									$sql = "SELECT * FROM students WHERE std_id NOT IN (SELECT std_id FROM tasheeh_std WHERE tasheeh_id = '".$_GET['t_id']."')
											AND students.state != 'مفصول'
