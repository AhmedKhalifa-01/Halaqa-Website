				...
				if(mysqli_query($conn,$sql)){
					...
					if($result){
						...
						if(mysqli_query($conn,$sql)){
							...
							echo "<script>window.location.href='std_more_details.php?id=".$_GET['std_id']."';</script>";
		...
		<div class="content">
			...
			<center style="margin-bottom:20px;"><a href="javascript:history.go(-1)" id="backbtn" class="button" style="width:100px;height:50px;">
				...
				<?php if(isset($_GET['std_id'])){?>
						<form class="login-form" id="myForm" action="ring_details_more_std_details.php?ring_id=<?php echo $_GET['ring_id'];?>&std_id=<?php echo $_GET['std_id'];?>" method="post" onsubmit="return validateForm()">
