...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>إحصائية الحلقات</title>
			...
			<?php if(isset($_GET['ring_id'])) {?>	
				<?php if(!isset($_GET['hide'])){?>
					<article class="card" style="width:300px;">
							...
							<div class="card-body">	
								<form class="login-form" action = "ring_stat_table.php?ring_id=<?php echo $_GET['ring_id']; ?>" method = "post" target="_blank">
							...
							while($row = mysqli_fetch_assoc($result)){
								echo '<article class="card">
										...
										echo '</div><div class="card-footer">
													<a style= "color:red;" href="ring_stat.php?ring_id='.$row['ring_id'].'">عرض الإحصائيات</a>
												</div>';
										echo '
									</article>
								';
