		...
		<div class="content">
			<div class="content-panel">
				<div class="vertical-tabs">
					...
					<a href="p_std_my_rewards.php">سجل المكافآت الخاص بالابن</a>
					<a href="p_std_my_cm.php" class="active">الدورات التي تحصل الابن عليها</a>
					<a href="p_change_pwd.php">تغيير كلمة المرور</a>
					<a href="p_send.php">مراسلة المعلم</a>
					<?php
						$sql = "SELECT * FROM messages WHERE user_id = '".$_SESSION['email']."' AND user_type = 2 AND seen = 0";
				...
				<center><table>
					...
					<?php
						$sql = "SELECT DISTINCT course.c_name, staff.staff_name,course_results.total_mark,course_results.result
								...
								WHERE course_details.std_id = '".$_GET['std_id']."'";
							...
							while($row = mysqli_fetch_assoc($result)){
								echo '<article class="card">
										...
										<div class="card-footer">
											<a href="p_std_my_cm.php?std_id='.$row['std_id'].'">مزيد من التفاصيل</a>
										</div>
									</article>
								';
							}
