...
/* adding new review plan */
	...
	if(isset($_POST['amrp'])){
			if(isset($_POST['mton'])){
				$mton = $_POST['mton'];
				$amount = $_POST['amount'];
				$sql = "DELETE FROM mton_review_plan WHERE std_id = '".$_GET['std_id']."'";
				mysqli_query($conn,$sql);
				$sql = "INSERT INTO `mton_review_plan`(`std_id`,`amount`,`sora`) VALUES ('".$_GET['std_id']."','".$amount."','".$mton."')";
		...
		<div class="content">
			...
			<div class="content-main">
				...
				<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="new_mton_review_plan.php?std_id=<?php echo $_GET['std_id']; ?>&mton_ring_id=<?php echo $_GET['mton_ring_id']; ?>" method="post">
								<div id = "sorah">
