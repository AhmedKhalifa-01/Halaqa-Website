...
<?php
    if(isset($_GET['ring_id'])){
      if($_SESSION['staff_job'] == "JOB_04"){
  ?>
  <center style="margin-bottom:20px;background-color:gray;width:50px;height:20px;margin:auto;"><a href="visitor_std_single_stat_select_date.php?type=3&std_id=<?php echo $_GET['std_id']; ?>&ring_id=<?php echo $_GET['ring_id']; ?>" class="button" style="margin-top:100px;width:100%;height:100%;color:white;">
            <span>اغلاق</span>
          </a></center>
  <?php }else{ ?>
    <center style="margin-bottom:20px;background-color:gray;width:50px;height:20px;margin:auto;"><a href="std_single_stat_select_date.php?type=3&std_id=<?php echo $_GET['std_id']; ?>&ring_id=<?php echo $_GET['ring_id']; ?>" class="button" style="margin-top:100px;width:100%;height:100%;color:white;">
            <span>اغلاق</span>
          </a></center>
  <?php }
      }else{ ?>
      <center style="margin-bottom:20px;background-color:gray;width:50px;height:20px;margin:auto;"><a href="std_my_stat.php" class="button" style="margin-top:100px;width:100%;height:100%;color:white;">
            <span>اغلاق</span>
          </a></center>
  <?php } ?>
