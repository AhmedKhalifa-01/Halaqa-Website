		...
		<div class="content">
			<div class="content-panel">
				<div class="vertical-tabs">
					...
					<a href="p_std_my_rewards.php"  class="active">سجل المكافآت الخاص بالابن</a>
					<a href="p_std_my_cm.php">الدورات التي تحصل الابن عليها</a>
					<a href="p_change_pwd.php">تغيير كلمة المرور</a>
					<a href="p_send.php">مراسلة المعلم</a>
					<?php
			...
			<div class="content-main">
				...
				?>
				<center>
					<p> اسم الطالب : <?php echo mysqli_fetch_assoc(mysqli_query($conn,"SELECT std_name FROM students WHERE std_id = '".$_GET['std_id']."'"))['std_name']; ?></p>
					
					<table class="det_table" style="margin-top:20px">
					<thead style="">
						<tr>
					...
					<tbody>
						<?php
							...
							$sql = "SELECT students.std_name,students.std_id,students.status,students.state,
									...
									WHERE prize_participating_students.prize_id = '".$_GET['prize_id']."' AND students.std_id = '".$_GET['std_id']."'
				...
				<?php 
							$sql = "SELECT * FROM prize
									...
									WHERE prize_details.std_id = '".$_GET['std_id']."'
								...
								//if($row['student_count'] > 0){
									echo '<article class="card">
											...
											<div class="card-footer">
												<a href="p_std_my_rewards.php?std_id='.$_GET['std_id'].'&prize_id='.$row['prize_id'].'">عرض التفاصيل</a>
											</div>';
						...
						if(mysqli_num_rows($result) > 0){
							while($row = mysqli_fetch_assoc($result)){
								echo '<article class="card">
										...
										<div class="card-footer">
											<a href="p_std_my_rewards.php?std_id='.$row['std_id'].'">مزيد من التفاصيل</a>
										</div>
									</article>
								';
							}
