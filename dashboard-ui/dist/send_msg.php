...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>إرسالة رسالة</title>
					...
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3 id="test">إرسال رسالة للمعلم</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="send.php?type=0">عرض المعلمين</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3 id="test">إرسال رسالة للطالب</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="send.php?type=1">عرض الطلاب</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3 id="test">إرسال رسالة لولي الأمر</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="send.php?type=2">عرض أولياء الأمور</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
							<div>
								<span><img src="imgs/icons/parent.png" /></span>
								<h3 id="test">رسالة جماعية</h3>
							</div>
						</div>
						<div class="card-body">
						</div>
						<div class="card-footer">
							<a href="mass_msg.php">إرسالة رسالة جماعية</a>
						</div>
					</article>
				</div>
			</div>
