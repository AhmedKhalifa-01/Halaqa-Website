									...
									echo '<article class="card">
											...
											if($_SESSION['staff_job'] == "JOB_01"){
												echo '<div class="card-footer">
														<a style= "color:red;" href="star_results_only.php?ring_id='.$row['ring_id'].'&prize_id='.$_GET['prize_id'].'">عرض النتائج</a>
													</div>';
													echo '<div class="card-footer">
														<a style= "color:red;" href="star_results.php?ring_id='.$row['ring_id'].'&prize_id='.$_GET['prize_id'].'">تعديل النتائج</a>
													</div>';
											}
