...
/* adding new mton */
	...
	if(isset($_POST['add_course'])){
		...
		$sql = "INSERT INTO `mton`(`mton_name`) VALUES ('".$name."')";
		$result = mysqli_query($conn,$sql);
		if($result){
			echo "<script>alert('تمت إضافة المتون بنجاح');</script>";
			echo "<script>window.location.href='mton_man.php';</script>";
		}else{
			echo "<script>alert('خطأ في إضافة المتون')</script>";
		}
	}
...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>إضافة متون جديد</title>
					...
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3>إضافة متون جديد</h3>
							</div>
						</div>
						<div class="card-body">
							<form class="login-form" action="new_mton.php" method="post">
								<p>اسم المتون</p>
								<input type="text" placeholder="اسم المتون" name="name">
