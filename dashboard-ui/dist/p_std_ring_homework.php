	...
	<div class="header-content responsive-wrapper">
		<div class="header-logo">
			...
			<div class="list">
					...
					<a href="p_std_all_myresults.php">نتائج الحفظ و المراجعة للابن</a>
		...
		<div class="content">
			<div class="content-panel">
				<div class="vertical-tabs">
					<a href="p_std_all_myresults.php" class="active">نتائج الحفظ و المراجعة للابن</a>
					<a href="p_std_my_mton_result.php">نتائج حفظ و مراجعة المتون للابن</a>
			...
			<center style="margin-bottom:20px;"><div><a href="p_std_all_myresults.php?std_id=<?php echo $_GET['std_id']; ?>" class="button" style="width:100px;height:50px;">
				...
				<center><table>
					...
					<?php
						$sql = "SELECT date FROM std_homework_soras WHERE std_id = '".$_GET['std_id']."' GROUP BY date ORDER BY date DESC LIMIT 7";
						...
						while($row = mysqli_fetch_assoc($result)){
							if(date('Y-m-d') == $row['date']){
								...
								$sql = "SELECT COALESCE(std_homework_soras.sora,'لا توجد سورة') as sor,s_from,s_to,date 
										...
										WHERE std_id = '".$_GET['std_id']."' AND type='review' AND date = '".$row['date']."'
										";
								...
								$sql = "SELECT COALESCE(std_homework_soras.sora,'لا توجد سورة') as sor,s_from,s_to,date 
										FROM std_homework_soras 
										WHERE std_id = '".$_GET['std_id']."' AND type='recite' AND date = '".$row['date']."'
										";
								$rres = mysqli_query($conn,$sql);
								if(mysqli_num_rows($rres) > 0){
									echo '<td class="td"><ul>';
