		...
		<div class="content">
			<div class="content-panel">
				<div class="vertical-tabs">
					...
					<a href="p_std_all_myresults.php">نتائج الحفظ و المراجعة للابن</a>
					<a href="p_std_my_mton_result.php">نتائج حفظ و مراجعة المتون للابن</a>
					<a href="p_std_my_att.php" class="active">سجل الحضور للابن</a>
				...
				<table style="width:300px;" class= "tt">
					...
					<?php
						$sql = "SELECT * FROM students 
								...
								LEFT JOIN std_att ON std_att.std_id = students.std_id
							...
							while($row = mysqli_fetch_assoc($result)){
								echo '<article class="card">
										...
										<div class="card-footer">
											<a href="p_std_my_att.php?std_id='.$row['std_id'].'">مزيد من التفاصيل</a>
										</div>
									</article>
								';
							}
