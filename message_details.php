...
<!-- partial:index.partial.html -->
	<form action="message_details.php" method="post" style="margin-right:100px;">		
		<center><div style="display:position:fixed;margin-auto;width:100%;">
			...
			<table>
				...
				<tbody>
				<?php
						$sql = "SELECT messages.msg_id, messages.msg, messages.date, 
									CASE messages.user_type 
									WHEN 1 THEN students.std_name 
									WHEN 0 THEN staff.staff_name 
									WHEN 2 THEN parent.p_name 
									END AS recipient_name
								FROM messages
								LEFT JOIN students ON messages.user_id = students.std_id AND messages.user_type = 1
								LEFT JOIN staff ON messages.user_id = staff.staff_id AND messages.user_type = 0
								LEFT JOIN parent ON messages.user_id = parent.p_id AND messages.user_type = 2
