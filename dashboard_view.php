		...
		<div class="content">
			<div class="content-panel">
				<div class="vertical-tabs">
					...
					<a href="ring_man.php">اضافة منتج جديد</a>
					
					<a href="mton_man.php" class="active">عرض او حذف المنتجات</a>
					<a href="course_man.php">تعديل على منتج</a>
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-footer">
							<a href="" style="color:red;">حذف المنتج</a>
						</div>
					</article>
					<article class="card">
						<div class="card-header">
