		...
		if(isset($_POST['teachers'])){
			...
			if (!empty($teachers)) {
				foreach ($teachers as $teacher_id) {
					$sql = "INSERT INTO teacher_ring (teacher_id, ring_id) VALUES ('".$teacher_id."','".$_GET['ring_id']."')";
...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>إضافة معلم للحلقة</title>
			...
			<div class="content-main">
				...
				<div class="card-grid">
					<article class="card">
						...
						<div class="card-body">
							<form class="login-form" action="add_teacher_existing_ring.php?ring_id=<?php echo $_GET['ring_id']; ?>" method="post">
