		...
		if(isset($_POST['teachers'])){
			...
			if (!empty($teachers)) {
				foreach ($teachers as $teacher_id) {
					$sql = "INSERT INTO tasheeh_teacher (tasheeh_id, teacher_id) VALUES ('".$_GET['t_id']."','".$teacher_id."')";
					...
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3>إضافة معلم للحلقة</h3>
							</div>
						</div>
						<div class="card-body">
							<form class="login-form" action="add_teacher_existing_tasheeh.php?t_id=<?php echo $_GET['t_id']; ?>" method="post">
								...
								<p>اختر المعلمين لإضافتهم للحلقة : </p>
								<ul>
									<?php
									...
									if(mysqli_num_rows($result) > 0) {
										...
										echo "لا يوجد معلمين لإضافتهم لإضافتهم.";
									}
									?>
								</ul>
