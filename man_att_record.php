...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>سجل حضور الإداريين</title>
		...
		<div class="content">
			...
			<div class="content-main">
				...
				<table>
					...
					<?php
						$sql = "SELECT * FROM staff_att 
								INNER JOIN staff ON staff_att.staff_id = staff.staff_id 
								WHERE staff.staff_job = 'JOB_02'
								ORDER by staff_job ASC";
