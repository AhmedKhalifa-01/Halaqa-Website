...
/* adding new course */
	...
	if(isset($_POST['add_course'])){
		...
		$sql = "UPDATE `course` SET `c_start_date`='".$start_date."',`c_end_date`='".$end_date."' WHERE c_id = ".$_GET['id']."";
...
<head>
<meta charset="UTF-8">
  <link rel="icon" sizes="120x120" href="../../images/lggo.png">  <title>تغيير زمن الدورة</title>
					...
					<article class="card">
						<div class="card-header">
							<div>
								...
								<h3>تغيير زمن الدورة</h3>
							</div>
						</div>
						<div class="card-body">
							<form class="login-form" action="change_course_end.php?id=<?php echo $_GET['id']?>" method="post" enctype="multipart/form-data">
